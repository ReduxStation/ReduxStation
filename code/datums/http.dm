// /datum/http_request: thin wrapper around rust-g's http_request_* APIs.
// Ported verbatim from tgstation/code/datums/http.dm. Phase 0 of TTS gives this
// its first caller; future systems (statbus webhooks, slimbus pings) can reuse
// the same wrapper.
