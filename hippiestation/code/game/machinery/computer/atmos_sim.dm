// Atmospherics simulator console.
//
// Ported from yogstation13/Yogstation commit 90b444a40 (November 2018):
// https://github.com/yogstation13/Yogstation/commit/90b444a40
//
// Two modes:
//   - TTV Bomb: two 70 L gas mixtures (bomb_1, bomb_2) that merge into
//     bomb_result and run up to 10 reactions. If pressure crosses
//     TANK_FRAGMENT_PRESSURE, three more reactions fire and the explosion
//     range is shown (light/heavy/devastation).
//   - Gas Reactions: single tank_mix at CELL_VOLUME for sandboxed gas
//     reactions. "Run Reaction Tick" hits react() once per click.
//
// Uses the legacy /datum/browser popup UI rather than tgui (no frontend
// needed). Sliders are href links; values are tweaked through input() prompts.
